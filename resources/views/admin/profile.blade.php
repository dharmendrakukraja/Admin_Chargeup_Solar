                                    ...
                                    <div class="profile-view">
                                        <div class="profile-img-wrap">
                                            <div class="profile-img">
                                                <a href="#"><img alt=""
                                                    src="<?php echo config("app.server_url") ?>/{{$data['profileImage'] }}">
                                            ...
                                            <div class="row">
                                                <div class="col-md-5">
                                                    <div class="profile-info-left">
                                                        <h3 class="user-name m-t-0 mb-0">@if(isset($data['firstName'])){{ $data['firstName'] }}@endif
                                                            @if(isset($data['lastName'])){{ $data['lastName'] }}@endif</h3>
                                                        <h6 class="text-muted">Admin of Solar - Charged Up Energy</h6>

                                                        {{-- <div class="staff-id">First Name : FT-0001</div>
                                                        <div class="staff-id">Last Name : FT-0001</div>
                                                        <div class="staff-id">Department : FT-0001</div>
                                                        <div class="staff-id">Designation : FT-0001</div>
                                                        <div class="staff-id">Address : FT-0001</div> --}}
                                                ...
                                                <div class="col-md-7">
                                                    <ul class="personal-info">
                                                        ...
                                                        <li>
                                                            ...
                                                            @if(isset($data['phoneNumber']))<div class="text"><a href="">
                                                                {{ $data['phoneNumber'] }}
                                                            </a></div>@endif
                                                        </li>
                                                        <li>
                                                    ...
                                                    <input onclick="window.location='{{ url("edit-profile",[$data['_id']]) }}'" type="button" value="Edit Profile" name="Edit" />
                                                </div>
                                            </div>
                                        </div>
