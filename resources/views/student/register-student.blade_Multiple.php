...
<!-- Page Wrapper -->
            <div class="page-wrapper">
                ...
                <form name="add-blog-post-form" enctype="multipart/form-data" id="register-form" method="POST" action="{{url('student-register')}}">
                    ...
                    <span id="add_more" style="float: right">Add More Course</span>
    ...
    $('select[name="courseId"]').on('change',function(){
     ...
     // Start Add More
       $('#add_more').click(function(){
        ...
        html += '<select class="select" id="course_name" required name="courseId"><option value="">Select Course</option>';
        ...
        html += '<div class="col-sm-6"  style="float: right;">';
                ...
                html += '<label class="control-label">Course Level</label><br><select class="select" required name="levelId"><option value="">Select Level</option>';

                html += '</select><button id="removeRow" type="button"  class="btn btn-danger" >Remove</button></div></div></div><link rel="stylesheet" href="http://127.0.0.1:8000/assets/css/select2.min.css">';
