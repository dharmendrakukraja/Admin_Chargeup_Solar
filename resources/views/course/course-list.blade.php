...
<!-- Page Wrapper -->
            <div class="page-wrapper">
                <form name="delete-list" enctype="multipart/form-data" id="delete-list" method="POST" action="{{url('delete-course-list')}}">
                    @csrf
                <!-- Page Content -->
                    ...
                    <div class="page-header">
                        <div class="row align-items-center">
                            ...
                            <div class="col-auto float-end ms-auto">
                                ...
                                <a style="margin-left:20px" href="{{url('add-course')}}" class="btn add-btn"><i class="fa fa-plus"></i> Add Course</a>
                                <button type="button" id="delete_all" data-bs-toggle="modal" data-bs-target="#delete_list"  class="btn add-btn"><i class="fa fa-minus"></i>Delete Course</button>
        ...
        <a  href="{{ route('edit-course', ['id' => $data['_id']]) }}">{{ Str::limit($data['courseName'], 40) }}</a>
                                                </h2>
                                            </td>
        <td><a  href="{{ route('edit-course', ['id' => $data['_id']]) }}">{{ Str::limit($data['description'], 400) }}</a></td>
                                            <td> @if($data['Course_Image']=='')
                                                {{-- <img src="http://173.212.217.22:5050/images/no-image.png" width="400px" height="400px" style="border-radius: 10%"> --}}
                                                <img src= "<?php $_SERVER['SERVER_NAME']?>/images/no-image.png" width="100px" height="100px" style="border-radius: 10%">
                                                @else
                                                <img src="http://173.212.217.22:5050/{{$data['Course_Image'] }}" width="100px" height="100px" style="border-radius: 10%">
                                                @endif
                                                {{-- <img src="http://173.212.217.22:5050/{{$data['Course_Image'] }}" width="100px" height="100px" style="border-radius: 10%"> --}}
                                            </td>
                                            ...
                                            <td class="text-end">
                                                <div class="dropdown dropdown-action">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right">
                                                        <a
                                                        href="{{ route('edit-course', ['id' => $data['_id']]) }}"
                            ...
                            <div class="modal-content">
                                <div class="modal-body">
                                    <div class="form-header">
                                        ...
                                        <p>Are you sure want to Delete Selected Courses ?</p>
                                    </div>
                                    <div class="modal-btn delete-action">
                                        <div class="row">
                                            <div id="" data-id="" class="col-6 inactive">
    ...
    //Ajax code
     ...
     //alert($('#inactive_val').val());
            $.ajax({
                type: 'DELETE',
               //type:'POST',
               url:'http://173.212.217.22:5050/api/admin/remove_course/'+val,
