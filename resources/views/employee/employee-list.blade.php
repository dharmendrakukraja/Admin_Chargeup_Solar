                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <h2 class="table-avatar">
                                                    ...
                                                    {{-- href="{{url('assignment-details',[$data['_id']])}}" --}}
                                                    >
                                            ...
                                            <td>
                                                ...
                                                <a title="Click here to see the Employee Details" href="{{ route('edit-employee', ['id' => $data['_id']]) }}">{{ Str::limit($data['address'], 300) }}</a>
                                            ...
                                            <td class="text-end">
                                                <div class="dropdown dropdown-action">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right">
                                                        <a
                                                        href="{{ route('edit-employee', ['id' => $data['_id']]) }}"
...
$( document ).ready(function() {
  ...
  $('.dataTables_length').addClass('bs-select');
    ...
    //Ajax code
     ...
     ip = '<?php echo config("app.server_url"); ?>';
    ...
    alert('CAlling ...');
            $.ajax({
               ...
               url:ip+'/admin/deleteEmployee/'+val,
               ...
               success:function(data) {
                   ...
                   //alert('AJAX');
                    if(data.status=='200'){
                        $("#message").html("Employee Deleted Successfully !");
                        $("#message").show();
