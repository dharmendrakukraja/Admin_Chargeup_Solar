...
<!-- Page Wrapper -->
            <div class="page-wrapper">
                ...
                <div class="page-header">
                    <div class="row align-items-center">
                        <div class="col">
                            <h3 class="page-title">Update Employee Order</h3>
                            <ul class="breadcrumb">
                                <li class="breadcrumb-item"><a href="index">Employee Order</a></li>
                                <li class="breadcrumb-item active">Update Employee Order</li>
                            </ul>
                        </div>

                    </div>
                </div>
                <form name="update-order-form" enctype="multipart/form-data" id="update-order-form" method="POST" action="{{url('employee-order-edit',[$orderDetails['_id']])}}">
<input type="hidden" name="employeeId" value="{{ $orderDetails['addedBy']['_id'] }}" />
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <div class="col-sm-6">
