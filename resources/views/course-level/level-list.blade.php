...
<!-- Page Wrapper -->
            <div class="page-wrapper">
                <form name="delete-list" enctype="multipart/form-data" id="delete-list" method="POST" action="{{url('delete-course-level-list')}}">
                    @csrf
                <!-- Page Content -->
                <div class="content container-fluid">
                    ...
                    <div class="page-header">
                        <div class="row align-items-center">
                            <div class="col">
                                <h3 class="page-title">Course-Level-List</h3>
                                <ul class="breadcrumb">
                            ...
                            <div class="col-auto float-end ms-auto">
                                ...
                                &nbsp;&nbsp;
                                <a style="margin-left:20px" href="{{url('add-level')}}" class="btn add-btn"><i class="fa fa-plus"></i> Add Course Level</a>
                                &nbsp;&nbsp;&nbsp;
                                <button type="button" id="delete_all" data-bs-toggle="modal" data-bs-target="#delete_list"  class="btn add-btn"><i class="fa fa-minus"></i>Delete Course Level</button>
                                            ...
                                            <td>
                                                <h2 class="table-avatar">
                                                    {{-- <a href="profile" class="avatar"><img alt="" src="assets/img/profiles/avatar-02.jpg"></a> --}}
                                                      ...
                                                      &nbsp;<a>
                                                       @if(isset($data['courseId']['courseName']))
                                            ...
                                            <td class="text-end">
                                                <div class="dropdown dropdown-action">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right">
                                                        <a
                                                        href="{{ route('edit-level', ['id' => $data['_id']]) }}"
                        ...
                        <div class="modal-content">
                            <div class="modal-body">
                                <div class="form-header">
                                    <h3>Delete Course Level</h3>
                                    <p>Are you sure want to Delete Course Level ?</p>
                                </div>
                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            <div class="modal-body">
                                <div class="form-header">
                                    <h3>Delete Course Level</h3>
                                    <p>Are you sure want to Delete Selected Course Level ?</p>
                                </div>
                                <div class="modal-btn delete-action">
                                    <div class="row">
                                        <div id="" data-id="" class="col-6 inactive">
    ...
    //Ajax code
     ...
     //alert($('#inactive_val').val());
            $.ajax({
                type: 'DELETE',
               //type:'POST',
               url:'http://173.212.217.22:5050/api/admin/delete_level/'+val,
               ...
               success:function(data) {
                   ...
                   //alert('AJAX');
                    if(data.status=='200'){
                        $("#message").html("Course Level Deleted Successfully !");
                        $("#message").show();
