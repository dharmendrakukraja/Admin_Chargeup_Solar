...
<!-- Page Wrapper -->
            <div class="page-wrapper">
                <form name="delete-list" enctype="multipart/form-data" id="delete-list" method="POST" action="{{url('delete-video-list')}}">
                    @csrf
                <!-- Page Content -->
                        ...
                        <div class="row align-items-center">
                            <div class="col">
                                ...
                                <ul class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">Live Videos List</li>
                                </ul>
                            </div>
                            <div class="col-auto float-end ms-auto">
                                {{-- <a href="#" class="btn add-btn" data-bs-toggle="modal" data-bs-target="#add_employee"><i class="fa fa-plus"></i> Add Employee</a> --}}
                                <a style="margin-left:20px" href="{{url('add-video')}}" class="btn add-btn"><i class="fa fa-plus"></i> Add Live Video</a>
                                <button type="button" id="delete_all" data-bs-toggle="modal" data-bs-target="#delete_list"  class="btn add-btn"><i class="fa fa-minus"></i>Delete Videos</button>
                                            ...
                                            <td><input class="checkbox" type="checkbox" name="list[]" value="{{$data['_id']}}"></td>
                                             <td width="200px">
                                                <h2 class="table-avatar">
                                                    ...
                                                    <a> @if(isset($data['videoName']))
                                                        {{$data['videoName']}}
                                                     @endif
                                                   </a>
                                                </h2>
                                             </td>
                                             <td width="200px"> @if(isset($data['courseId']['courseName']))
                                                 {{$data['courseId']['courseName'] }}
                                                 @endif
                                              </td>
                                             <td width="20px" style="text-align:center">@if(isset($data['levelId']['Level']))
                                                 {{$data['levelId']['Level'] }}
                                                 @endif
                                             </td>
                                             @if(isset($data['videoDescription']))
                                             <td><a  href="{{ route('edit-video', ['id' => $data['_id']]) }}">{{ Str::limit($data['videoDescription'], 400) }}</a>
                                                 </td>
                                             @endif

                                            <td width="20px" class="text-end">
                                                <div class="dropdown dropdown-action">
                                                    <a href="#" class="action-icon dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false"><i class="material-icons">more_vert</i></a>
                                                    <div class="dropdown-menu dropdown-menu-right">

                                                        <a
                                                        href="{{ route('edit-video', ['id' => $data['_id']]) }}"
                        ...
                        <div class="modal-content">
                            <div class="modal-body">
                                <div class="form-header">
                                    <h3>Delete Live Video</h3>
                                    <p>Are you sure want to Delete Live Video ?</p>
                                </div>
                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            <div class="modal-body">
                                <div class="form-header">
                                    <h3>Delete Video</h3>
                                    <p>Are you sure want to Delete Selected Video ?</p>
                                </div>
                                <div class="modal-btn delete-action">
                                    <div class="row">
                                        <div id="" data-id="" class="col-6 inactive">
    ...
    //Ajax code
     ...
     //alert($('#inactive_val').val());
            $.ajax({
                type: 'DELETE',
               //type:'POST',
               url:'http://173.212.217.22:5050/api/admin/delete_Video/'+val,
               ...
               success:function(data) {
                   ...
                   //alert('AJAX');
                    if(data.status=='200'){
                        $("#message").html("Live Video Deleted Successfully !");
                        $("#message").show();
