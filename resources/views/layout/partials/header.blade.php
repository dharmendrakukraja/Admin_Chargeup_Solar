<!-- Header -->
            <div class="header">
                ...
                <div class="header-left">
                    <a href="" class="logo">
                        <img style="" src="{{  url('assets/img/solar-logo.png') }}" width="60" height="60" alt="">
                        {{-- <img src="assets/img/solar-logo.png" alt="Solar Admin"> --}}
                    </a>
                </div>
                <!-- /Logo -->
                ...
                <div class="page-title-box">
                    <h3>Solar - Charged Up Energy</h3><h4></h4>
                </div>
                <!-- /Header Title -->
                ...
                <ul class="nav user-menu">
                    ...
                    <li class="nav-item dropdown has-arrow main-drop">
                        ...
                        <div class="dropdown-menu">
                            ...
                            href="{{url('profile', [Session::get('userData')['_id']] )}}"
                            >My Profile</a>
