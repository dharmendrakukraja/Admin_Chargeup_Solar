...
<!-- Page Wrapper -->
            <div class="page-wrapper">
                <form name="delete-list" enctype="multipart/form-data" id="delete-list" method="POST" action="{{url('delete-assignment-list')}}">
                    @csrf
                <!-- Page Content -->
                    ...
                    <div class="page-header">
                        <div class="row align-items-center">
                            ...
                            <div class="col-auto float-end ms-auto">
                                ...
                                <a style="margin-left:20px" href="{{url('add-assignment')}}" class="btn add-btn"><i class="fa fa-plus"></i> Add Assignment</a>
                                <button type="button" id="delete_all" data-bs-toggle="modal" data-bs-target="#delete_list"  class="btn add-btn"><i class="fa fa-minus"></i>Delete Assignment</button>
                        ...
                        <div class="col-md-12">
                            <div class="table-responsive">
                                {{-- <table class="table table-striped custom-table datatable"> --}}
                                    ...
                                    <tbody>
                                        @foreach($assignmentList as $data)
                                        <tr>
                                            <td><input class="checkbox" type="checkbox" name="list[]" value="{{$data['_id']}}"></td>
                                             <td>{{$data['assignmentName']}}</td>

                                             <td> @if(isset($data['courseId']['courseName']))
                                                 {{$data['courseId']['courseName'] }}
                                                 @endif
                                                </td>
                                             <td style="text-align:center">@if(isset($data['levelId']['Level']))
                                                 {{$data['levelId']['Level'] }}
                                                 @endif
                                                </td>

                                             <td><a  href="{{ route('edit-assignment', ['id' => $data['_id']]) }}">@if(isset($data['description']))
                                            ...
                                            <td class="text-end">
                                                <div class="dropdown dropdown-action">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right">
                                                        <a
                                                        href="{{ route('assign-assignment', ['id' => $data['_id']]) }}"
                                                        class="dropdown-item"><i class="fa fa-address-book-o  m-r-5"></i> Assign</a>
                                                        <a
                                                        href="{{ route('edit-assignment', ['id' => $data['_id']]) }}"
                        ...
                        <div class="modal-content">
                            <div class="modal-body">
                                <div class="form-header">
                                    ...
                                    <p>Are you sure want to Delete Assignment ?</p>
                                </div>
                ...
                <!-- /Delete Employee Modal -->
                 <!-- Delete Multiple Assignment Model-->
                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            <div class="modal-body">
                                <div class="form-header">
                                    <h3>Delete Assignment</h3>
                                    <p>Are you sure want to Delete Selected Assignment ?</p>
                                </div>
                                <div class="modal-btn delete-action">
                                    <div class="row">
                                        <div id="" data-id="" class="col-6 inactive">
    ...
    //Ajax code
     ...
     //alert($('#inactive_val').val());
            $.ajax({
                type: 'DELETE',
               //type:'POST',
               url:'http://173.212.217.22:5050/api/admin/Delete_assignment/'+val,
               ...
               success:function(data) {
                   ...
                   //alert('AJAX');
                    if(data.status=='200'){
                        $("#message").html("Assignment Deleted Successfully !");
                        $("#message").show();
