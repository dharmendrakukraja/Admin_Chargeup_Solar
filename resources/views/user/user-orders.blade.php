                ...
                <div class="content container-fluid">
                    ...
                    <div class="page-header">
                        <div class="row align-items-center">
                            <div class="col">
                                <h3 class="page-title">User Orders</h3>
                                <ul class="breadcrumb">
                            ...
                            <div class="col-auto float-end ms-auto">
                                ...
                                {{-- <a style="margin-left:20px" href="{{url('user-list-pdf')}}" class="btn add-btn"><i class="fa fa-plus"></i> Add Employee</a> --}}
                                            ...
                                            <td class="text-end">
                                                <div class="dropdown dropdown-action">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right">
                                                        {{-- <a
                                                        href="{{ route('user-order-assign', ['id' => $data['_id']]) }}"
                                                        class="dropdown-item"><i class="fa fa-pencil m-r-5"></i> Assign</a>
                                                        <a
                                                        href="{{ route('user-order-edit', ['id' => $data['_id']]) }}"
                                                        class="dropdown-item"><i class="fa fa-pencil m-r-5"></i> Edit</a> --}}
                                                        {{-- <a class="dropdown-item getidval"    href="{{ route('user-order-detail', ['id' => $data['_id']]) }}"
