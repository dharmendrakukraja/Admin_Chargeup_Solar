...
<!-- Page Wrapper -->
            <div class="page-wrapper">
                {{-- <form name="delete-list" enctype="multipart/form-data" id="" method="POST" action="{{url('delete-announcement-list')}}"> --}}
                    @csrf
                <!-- Page Content -->
                <div class="content container-fluid">
                    ...
                    <div class="page-header">
                        <div class="row align-items-center">
                            <div class="col">
                                <h3 class="page-title">Employee Notification</h3>
                                <ul class="breadcrumb">
                            ...
                            <div class="col-auto float-end ms-auto">
                                ...
                                <a style="margin-left:20px" href="{{url('add-employee-notification')}}" class="btn add-btn"><i class="fa fa-plus"></i> Add Notification</a>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            {{-- <td><input class="checkbox" type="checkbox" name="list[]" value="{{$data['_id']}}"></td> --}}
                                              <td style="width: 300px">@if(isset($data['subject'])){{$data['subject']}}@endif </td>
                                              <td>@if(isset($data['message']))<a  href="{{ route('edit-announcement', ['id' => $data['_id']]) }}">{{ Str::limit($data['message'], 400) }}</a>@endif</td>
                ...
                <div class="modal custom-modal fade" id="delete_employee" role="dialog">
                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        <form name="delete-list" id="delete-list" method="POST" action="{{url('delete-employee-notification')}}">
                            @csrf
                        <div class="modal-content">
                            <div class="modal-body">
                                <div class="form-header">
                                    <h3>Delete Notification</h3>
                                    <p>Are you sure want to Delete Notification ?</p>
                                </div>
...
<a data-bs-dismiss="modal" data-id="" href="javascript:void(0);" class="btn btn-primary submit continue-btn">Delete</a>
                                        </div>
