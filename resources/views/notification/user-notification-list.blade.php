            ...
            <div class="page-wrapper">
                ...
                <div class="content container-fluid">
                    ...
                    <div class="page-header">
                        <div class="row align-items-center">
                            <div class="col">
                                <h3 class="page-title">User Notification</h3>
                                <ul class="breadcrumb">
                            ...
                            <div class="col-auto float-end ms-auto">
                                ...
                                <a style="margin-left:20px" href="{{url('add-user-notification')}}" class="btn add-btn"><i class="fa fa-plus"></i> Add Notification</a>
                ...
                <div class="modal custom-modal fade" id="delete_employee" role="dialog">
                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        <form name="delete-list" id="delete-list" method="POST" action="{{url('delete-user-notification')}}">
                            @csrf
